...
export const createStyles = async ({ themeData }) => {
    /** @type {{Gradient1, Gradient2, PrimaryColor, Black, White, TextInputColor, TextColor, TextInputPlaceholderColor, ShadowColor,}} */
    ...
    return StyleSheet.create({
        ...
        left0: { left: 0 },
        top1: { top: -16 },
        right1: { right: normalize(55) },
        right2: { right: normalize(55) },
        bottom1: { bottom: normalize(20) },
        left1: { left: -16 },
        top2: { top: -32 },
        bottom2: { bottom: normalize(10) },
        left2: { left: -32 },
        ...
        fw9: { fontWeight: '900' },
        h1: { height: 16 },
        h2: { height: normalize(12) },
        h3: { height: 64 },
        h4: { height: 128 },
        h5: { height: 256 },
        h6: { height: normalize(60) },
